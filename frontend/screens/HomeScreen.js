...
import { MyComponent } from '../MyComponent'; // ✅ Add this import here
...
export default function HomeScreen({ navigation, route }) {
  ...
  const onSummarize = async () => {
    if (!url) return Alert.alert('Enter YouTube URL');
    try {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Paste YouTube URL" style={styles.input} value={url} onChangeText={setUrl} />
      ...
      {/* ✅ Add your custom component below the list */}
...
const styles = StyleSheet.create({
  ...
  langBtn: { padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#ddd', flex: 1, marginRight: 8, alignItems: 'center', justifyContent: 'center' },
  actionBtn: { padding: 12, borderRadius: 8, backgroundColor: '#2e78b7', alignItems: 'center', justifyContent: 'center' },
});
